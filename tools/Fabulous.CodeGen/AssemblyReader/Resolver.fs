...
module Resolver =
    ...
    let rec private getAllTypesDerivingFromBaseTypeInner (allTypes: TypeDefinition list) baseTypeName =
    ...
    and private filterTypesDerivingFromBaseType (allTypes: TypeDefinition list) baseTypeName =
        allTypes
    ...
    and private findAllDerivingTypes (allTypes: TypeDefinition list) (typesToCheck: TypeDefinition list) (matchingTypes: TypeDefinition list) =
